        ...
        <Container>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-8 text-sm text-white/60 font-body font-light leading-relaxed">
              <section>
                <h2 className="font-heading italic text-2xl text-white mb-3">1. Information We Collect</h2>
              ...
              <section>
                <h2 className="font-heading italic text-2xl text-white mb-3">2. How We Use Your Information</h2>
              ...
              <section>
                <h2 className="font-heading italic text-2xl text-white mb-3">3. Data Protection</h2>
              ...
              <section>
                <h2 className="font-heading italic text-2xl text-white mb-3">4. Cookies</h2>
              ...
              <section>
                <h2 className="font-heading italic text-2xl text-white mb-3">5. Contact</h2>
