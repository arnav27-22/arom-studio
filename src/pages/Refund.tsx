        ...
        <Container>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-8 text-sm text-white/60 font-body font-light leading-relaxed">
              <section>
                <h2 className="font-heading italic text-2xl text-white mb-3">1. Project Deposits</h2>
              ...
              <section>
                <h2 className="font-heading italic text-2xl text-white mb-3">2. Project Cancellation</h2>
              ...
              <section>
                <h2 className="font-heading italic text-2xl text-white mb-3">3. Completed Projects</h2>
              ...
              <section>
                <h2 className="font-heading italic text-2xl text-white mb-3">4. Maintenance & Support</h2>
                <p>Monthly maintenance fees are non-refundable but can be cancelled with 30 days&apos; notice.</p>
              </section>

              <section>
                <h2 className="font-heading italic text-2xl text-white mb-3">5. Dispute Resolution</h2>
