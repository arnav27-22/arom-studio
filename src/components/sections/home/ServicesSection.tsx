...
const featuredServices = [
  { slug: 'business-websites', title: 'Business Websites', description: 'High-performance websites that establish credibility and drive leads. Backed by 3+ Years Experience & Free Domain.', icon: 'Building2' },
    ...
    <Section>
      <Container>
        <SectionHeader
          ...
          description="From business websites to custom SaaS platforms, we build digital products that combine premium design with engineering excellence. Backed by 3+ Years Experience and Free Domain."
        />

        <div className="mb-10 flex flex-wrap items-center justify-center gap-3 text-xs text-white/50 font-body">
          <span className="flex items-center gap-1"><Check className="h-3 w-3 text-accent" /> 3+ Years Experience</span>
