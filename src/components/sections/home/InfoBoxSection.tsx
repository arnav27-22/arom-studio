        ...
        <FadeIn>
          <div className="glass-strong rounded-[32px] p-8 md:p-12 lg:p-16 max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="mt-4 text-base text-white/80 font-body font-light max-w-xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <span className="text-xs text-white/75 font-body uppercase tracking-wider mb-1">Phone</span>
              ...
              >
                ...
                <span className="text-xs text-white/75 font-body uppercase tracking-wider mb-1">Email</span>
              ...
              >
                ...
                <span className="text-xs text-white/75 font-body uppercase tracking-wider mb-1">WhatsApp</span>
              ...
              <div className="glass rounded-[24px] p-6 md:p-8 flex flex-col items-center md:items-start text-center md:text-left group">
                ...
                <span className="text-xs text-white/75 font-body uppercase tracking-wider mb-1">Location</span>
