      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-5xl mx-auto pt-32">
        ...
        >
          <div className="glass rounded-[20px] p-4 md:p-5 w-[160px] md:w-[200px]">
            ...
            <p className="font-heading text-4xl md:text-5xl text-white tracking-[-1px] leading-none">3+</p>
          ...
          <div className="glass rounded-[20px] p-4 md:p-5 w-[160px] md:w-[200px]">
            ...
            <p className="font-heading text-4xl md:text-5xl text-white tracking-[-1px] leading-none">50+</p>
          ...
          <div className="glass rounded-[20px] p-4 md:p-5 w-[160px] md:w-[200px]">
            ...
            <p className="font-heading text-4xl md:text-5xl text-white tracking-[-1px] leading-none">95+</p>
