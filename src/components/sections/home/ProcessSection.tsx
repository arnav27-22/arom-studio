  ...
  return (
    <Section>
      <Container>
        ...
        <div className="mb-10 flex flex-wrap items-center justify-center gap-4 text-xs text-white/80 font-body">
          ...
          {steps.map((step, i) => (
            <StaggerItem key={i} className="h-full">
              <div className="glass rounded-[24px] p-6 relative group hover:shadow-[0_0_30px_0_rgba(78,133,191,0.08)] transition-all duration-500 flex flex-col h-full">
                <span className="font-heading text-6xl text-white/10 absolute -top-2 -right-2 leading-none select-none">
                ...
                <div className="flex items-start justify-between mb-2">
                  ...
                  <span className="text-[10px] text-accent font-body font-medium whitespace-nowrap ml-2 mt-1">{step.time}</span>
                </div>
