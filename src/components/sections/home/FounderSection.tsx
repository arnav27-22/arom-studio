          ...
          <div className="glass rounded-[32px] p-8 md:p-12 lg:p-16 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-start gap-10 lg:gap-16">
              ...
              <div className="flex-1">
                <span className="text-xs text-white/75 font-body uppercase tracking-[0.2em]">Founder</span>
                ...
                <p className="text-base text-white/80 font-body font-light leading-relaxed max-w-2xl">
                ...
                <div className="flex items-center gap-6 mt-6">
                  <Link
                    to="/about"
                    className="text-sm text-white/85 hover:text-white transition-colors font-body font-light inline-flex items-center gap-1.5"
                  >
                    More about me
